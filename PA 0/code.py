...
value1=st.norm.pdf(2,loc=5,scale=15)
#print(value1)
...
a=tf.random_normal(shape=[1],mean=-1.0,stddev=4,dtype=tf.float32,seed=0, name=None)
sess = tf.Session()
value3=sess.run(a)
#print(sess.run(a))
...
array=np.arange(12)
value4=sk.utils.shuffle(array,random_state=5)
#print(value4)
